...
import DashboardSettingsCreateModule from "./DashboardSettingsCreateModule";
            ...
            <ModuleList>
              ...
              <ModuleListItem className="bg-secondary/30 py-5">
                <div className="w-full flex justify-center">
                  <Button>Přidat Kurz/Materiál</Button>
                </div>
              </ModuleListItem>
            </ModuleList>
          </div>
          <DashboardSettingsCreateModule />
        </div>
      </div>
